    ...
    <div class="content-page">
        <div class="templates add-task-template">
            <div class="page-header">
                <h1>{{ __('projectsquare::tasks.add_task') }}</h1>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="{{ __('projectsquare::tasks.title_placeholder') }}" name="title" value="{{{ $data['title'] }}}"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="12" placeholder="{{ __('projectsquare::tasks.description') }}" name="description">{{{ $data['description'] }}}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="estimated_time_days" style="display: inline-block; width: 6rem; margin-right: 0.5rem;" value="{{{ $data['estimatedTimeDays'] }}}" /> {{ __('projectsquare::generic.days') }}
                            <input class="form-control" type="text" name="estimated_time_hours" style="display: inline-block; width: 6rem; margin-left: 1rem; margin-right: 0.5rem;" value="{{{ $data['estimatedTimeHours'] }}}" /> {{ __('projectsquare::generic.hours') }}
                        </div>

                        <div class="form-group" style="display: none">
                            <label for="estimated_time">{{ __('projectsquare::tasks.spent_time') }}</label><br>
                            <input class="form-control" type="text" name="spent_time_days" style="display: inline-block; width: 6rem; margin-right: 0.5rem;" value="{{{ $data['spentTimeDays'] }}}" /> {{ __('projectsquare::generic.days') }}
                            <input class="form-control" type="text" name="spent_time_hours" style="display: inline-block; width: 6rem; margin-left: 1rem; margin-right: 0.5rem;" value="{{{ $data['spentTimeHours'] }}}" /> {{ __('projectsquare::generic.hours') }}
                        </div>
                    </div>
                </div>
