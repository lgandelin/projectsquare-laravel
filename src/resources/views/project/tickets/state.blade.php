            ...
            @if (!$is_client)
                <div class="form-group">
                    <div style="display: inline-block">
                        ...
                        <input class="form-control" type="text" name="estimated_time_hours" style="display: inline-block; width: 6rem; margin-right: 0.5rem;" value="@if (isset($ticket) && isset($ticket->states[0]) && isset($ticket->states[0]->estimatedTimeHours)){{ $ticket->states[0]->estimatedTimeHours }}@endif" /> {{ __('projectsquare::generic.hours') }}
                    </div>

                    <div style="display: inline-block; margin-left: 1rem;">
                        <label for="estimated_time">{{ __('projectsquare::tasks.spent_time') }}</label><br>
                        <input class="form-control" type="text" name="spent_time_hours" style="display: inline-block; width: 6rem; margin-right: 0.5rem;" value="@if (isset($ticket) && isset($ticket->states[0]) && isset($ticket->states[0]->spentTimeHours)){{ $ticket->states[0]->spentTimeHours }}@endif" /> {{ __('projectsquare::generic.hours') }}
                    </div>
                </div>
            @endif
        </div>
