...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="message-view-template conversation">
            ...
            <a href="{{ route('project_index', ['id' => $conversation->project->id]) }}"><span class="label label-primary">{{ $conversation->project->client->name }}</span> {{ $conversation->project->name }}</a><br><br/>
