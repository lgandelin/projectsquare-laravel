        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" @if (isset($ticket) && $ticket->id) disabled @endif type="text" placeholder="{{ trans('projectsquare::tickets.title_placeholder') }}" name="title" @if (isset($ticket_title))value="{{ $ticket_title }}"@endif />
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" @if (isset($ticket) && $ticket->id) disabled @else rows="10" @endif placeholder="{{ trans('projectsquare::tickets.description') }}" name="description">@if (isset($ticket_description)){{ $ticket_description }}@endif</textarea>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datepicker" type="text" placeholder="{{ trans('projectsquare::tickets.due_date_placeholder') }}" name="due_date" @if (isset($ticket_due_date))value="{{ $ticket_due_date }}"@endif autocomplete="off" />
                </div>
