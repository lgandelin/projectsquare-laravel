...
class TicketStatusController extends BaseController
{
    public function index(Request $request)
    {
        ...
        return view('projectsquare::administration.ticket_statuses.index', [
    ...
    public function add(Request $request)
    {
        ...
        return view('projectsquare::administration.ticket_statuses.add', [
        ]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('projectsquare::administration.ticket_statuses.edit', [
